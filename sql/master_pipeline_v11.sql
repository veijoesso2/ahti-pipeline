-- =====================================================================
-- AHTI PADDLE MAP PIPELINE - MASTER SCRIPT v13 (FULL TOPOLOGY CHECK)
-- =====================================================================
-- v13 Changes:
-- 1. FIXED "False Terminal" bug (River Loops/Forks).
--    New logic: A point is a terminal ONLY if it does not touch ANY part 
--    (interior or boundary) of another river segment.
-- 2. Preserves v12.1 casting fixes.
-- =====================================================================

\echo '╔════════════════════════════════════════════════════════════════╗'
\echo '║  AHTI PADDLE MAP PIPELINE - MASTER SCRIPT v13                ║'
\echo '╚════════════════════════════════════════════════════════════════╝'
\echo ''
...
-- =====================================================================
-- STEP 4: AGGREGATE RIVERS (Skipped)
-- =====================================================================
\echo '[4/12] Aggregating Rivers (Skipped)...'
...
-- This fixes the "loop attached to middle of river" bug.
...
WHERE NOT EXISTS (
    ...
    -- CRITICAL FIX: Check intersection with FULL GEOMETRY, not just endpoints
...
JOIN candidate_objects l 
    ON l.type = 'lake' AND ST_DWithin(tt.pt, l.geom, 50) -- Snap tolerance
WHERE r.type = 'river';
...
\echo '  ✓ Smart connectors created (Full Topology Check)'
